...
class CsvWriter:
    ...
    def __init__(self, out_file: str, checkpoint_every: int = 0):  # arg kept but ignored
        ...
        self.fieldnames = ["status", "paper_url", "joss_id", "title", "repo_url", "repo_status_code", "created_at"]
    ...
    def add(self, rec: Record) -> None:
        ...
        row = {k: getattr(rec, k, None) for k in ["status", "paper_url", "joss_id", "title", "repo_url", "repo_status_code", "created_at"]}
